...
Готовый набор для отправки шаблонов в официальный репозиторий Wiren Board: [`contrib/wb-community-pr/`](../contrib/wb-community-pr/) (инструкция, текст PR, скрипт `apply-to-fork.sh`).
